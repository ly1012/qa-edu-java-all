...
public class SimpleTestListener implements ITestListener {
   ...
   * com.liyun.qa.edu.listener.simple.SimpleTestListener.onStart(SimpleTestListener.java:45)
   * com.liyun.qa.edu.listener.simple.SimpleTestListener.onFinish(SimpleTestListener.java:50)
   * com.liyun.qa.edu.listener.simple.SimpleTestListener.onStart(SimpleTestListener.java:45)
   * com.liyun.qa.edu.listener.simple.SimpleTestListener.onFinish(SimpleTestListener.java:50)
   *

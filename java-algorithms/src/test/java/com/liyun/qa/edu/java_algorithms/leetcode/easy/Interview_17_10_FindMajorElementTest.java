...
public class Interview_17_10_FindMajorElementTest {

  @Test(dataProvider = "testcase")
  public void testByStatistics(int[] nums,int expected) {
    assertEquals(Interview_17_10_FindMajorElement.byStatistics(nums), expected);
  }

  @Test(dataProvider = "testcase")
  public void testByBoyer_MooreMajorityVoteAlgorithm(int[] nums,int expected) {
    assertEquals(Interview_17_10_FindMajorElement.byBoyer_MooreMajorityVoteAlgorithm(nums), expected);
  }
